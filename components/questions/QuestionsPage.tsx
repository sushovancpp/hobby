    ...
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <i className="fa-solid fa-circle-user text-xs" />
          ...
          {backLabel ? (
            <button
              ...
              style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.15)", color: "var(--muted)" }}
            >
            ...
            <button
              ...
              style={{ background: "rgba(255,71,87,0.12)", border: "1px solid rgba(255,71,87,0.35)", color: "#ff4757" }}
            >
