    ...
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {/* Admin: Manage Questions button */}
          {user.role === "admin" && (
            <button
              onClick={() => setShowAdmin(true)}
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-bold font-syne transition-all hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(255,165,0,0.35)]"
              style={{
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 md:px-6 py-8 pb-20">
        ...
        {user.role === "admin" && (
          <div
            className="flex items-center justify-between gap-3 px-4 py-3 rounded-xl mb-5 text-sm"
          ...
          >
            ...
            <button
              onClick={() => setShowAdmin(true)}
              className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold font-syne transition-all hover:bg-orange-400/20"
              style={{ background: "rgba(255,165,0,0.15)", border: "1px solid rgba(255,165,0,0.3)", color: "orange" }}
            >
              <i className="fa-solid fa-database text-xs" />
              Manage
            </button>
